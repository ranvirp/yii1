 ...
 * @property string $revenue_viilage_code
 *
 * The followings are the available model relations:
 * @property RevenueVillage $revenueViilageCode
 */
class School extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('revenue_viilage_code', 'length', 'max'=>15),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name_en, name_hi, revenue_viilage_code', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'revenueViilageCode' => array(self::BELONGS_TO, 'RevenueVillage', 'revenue_viilage_code'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'revenue_viilage_code' => Yii::t('app','Revenue Viilage Code'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('revenue_viilage_code',$this->revenue_viilage_code,true);
