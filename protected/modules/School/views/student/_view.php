...
<div class="view">
	...
	<?php
	echo '<img src="'.$this->createUrl('/utility/').'/'.$data->getAttachment('thumb').'" />'; //thumbnail
echo '<img height="200px" width="200px" src="'.$this->createUrl('/utility/').'/'.$data->getAttachment().'" />';
?>

	<b><?php 
	echo CHtml::encode($data->getAttributeLabel('rollno')); ?>:</b>
