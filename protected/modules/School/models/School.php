 ...
 * Returns list of schools concerned with the officer logged in 
 */
	public static function listAllByOfficer()
	{
		...
		{
			$sql ="select * from school where district_code=:district_code";
		...
		{
			$sql ="select * from school where block_code=:block_code";
			$command = Yii::app()->db->createCommand($sql);
		...
		{
			$sql ="create * from school where 0";
			$command = Yii::app()->db->createCommand($sql);
