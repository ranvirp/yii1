 ...
 * @property SkillLevelCategory[] $skillLevelCategories
 */
class Subject extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('code, name_hi, name_en', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'skillLevels' => array(self::HAS_MANY, 'SkillLevel', 'subject_code'),
			'skillLevelCategories' => array(self::HAS_MANY, 'SkillLevelCategory', 'subject_code'),
		);
	}
