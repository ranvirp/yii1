...
class SchoolController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','getLocationForm'),
				'users'=>array('@'),
			),
	...
	public function actionGetLocationForm($t,$name)
	{
		if ($t=='r')
		{
			print $this->renderPartial('Basedata.views.revenueVillage.withblock',array('name'=>$name),false);
		}
		else print '';
	}
}