...
<div class="form">
    ...
    'enableAjaxValidation'=>false,
        ...
        'action'=>Yii::app()->createUrl('importModels/import/do/m/'School
)); ?>
    ...
    <table class='table'><tr><th>Column of Model</th><th>Type</th><th>Col. No. in XLSX</th></tr>     <?php echo '<tr><td>name_en</td><td>string<td>'.TbHtml::dropDownList('name_en'.'_xlsx',1,range(-1,30)); ?>
     ...
     <?php echo '<tr><td>location_name</td><td>string<td>'.TbHtml::dropDownList('location_name'.'_xlsx',7,range(-1,30)); ?>

     <?php echo '<tr><td>district_code</td><td>string<td>'.TbHtml::dropDownList('district_code'.'_xlsx',8,range(-1,30)); ?>

     <?php echo '<tr><td>block_code</td><td>string<td>'.TbHtml::dropDownList('block_code'.'_xlsx',9,range(-1,30)); ?>
